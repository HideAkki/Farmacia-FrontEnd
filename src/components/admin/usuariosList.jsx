...
export const UsuariosLista = function() {
  return(
    <>
              ...
              <div className="row justify-content-center">
                  ...
                  <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
                      <div className="card border-0 shadow-lg hover-zoom" style={{width: "auto"}}>
                          ...
                          <div className="card-body text-center">
                              <h5 className="fw-bold"><a href="/admin/usuarios/empleado">EMPLEADOS </a></h5>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
                      <div className="card border-0 shadow-lg hover-zoom" style={{width: "auto"}}>
                          ...
                          <div className="card-body text-center">
                              <h5 className="fw-bold"><a href="/admin/usuarios/administrador">ADMINISTRADORES</a></h5>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="col-12 col-md-4 d-flex justify-content-center mb-4">
                      <div className="card border-0 shadow-lg hover-zoom" style={{width: "auto"}}>
                          ...
                          <div className="card-body text-center">
                              <h5 className="fw-bold"><a href="/admin/usuarios/directivos">DIRECTIVOS</a></h5>
                          </div>
                      </div>
                  </div>
              </div>
